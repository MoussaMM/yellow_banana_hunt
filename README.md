...
2. Place the file in the DRLND GitHub repository, in the `Yellow_banana_hunt` folder, and unzip (or decompress) the file.

## Step 3: Run all the cells of Navigation.ipynb
Running all the cells will train the agent, save a checkpoint after reaching 13 score and finally test the agent from the checkpoint on 100 steps. If you want to use the already existing checkpoint you can skip the training cell.